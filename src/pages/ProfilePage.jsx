  ...
  return (
    <div className="min-h-screen bg-pupa-bg pt-16 pb-24 page-enter">
      <div className="px-5 pt-4">
        ...
        {/* Log out */}
        <button className="w-full mt-4 p-4 rounded-xl border border-red-500/20 text-red-400 flex items-center justify-center gap-2 hover:bg-red-500/10 transition-colors text-sm font-body">
          <LogOut size={16} />
          Sign Out
        </button>
