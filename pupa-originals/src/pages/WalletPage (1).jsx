...
const MOVIE_GIFTS = [
  { id: 'popcorn', name: 'Popcorn', icon: Popcorn, price: 100, color: '#fbbf24', animation: 'bounce' },
  { id: 'heart', name: 'Heart', icon: Heart, price: 200, color: '#ef4444', animation: 'pulse' },
  { id: 'flame', name: 'Fire', icon: Flame, price: 500, color: '#f97316', animation: 'shake' },
  { id: 'sparkle', name: 'Sparkle', icon: Sparkles, price: 1000, color: '#a78bfa', animation: 'spin' },
  { id: 'diamond', name: 'Diamond', icon: Diamond, price: 5000, color: '#06b6d4', animation: 'glow' },
  { id: 'crown', name: 'Crown', icon: Crown, price: 10000, color: '#facc15', animation: 'float' },
  { id: 'zap', name: 'Thunder', icon: Zap, price: 2500, color: '#eab308', animation: 'flash' },
  { id: 'film', name: 'Reel', icon: Film, price: 750, color: '#22c55e', animation: 'rotate' },
];
...
export default function WalletPage() {
  ...
  // Simulate earning points every 30 minutes of watch time
  useEffect(() => {
    ...
    }, 60000); // Every minute (for demo - in real app this would track actual watch time)
  ...
  const handleRegionChange = (newRegion) => {
    setRegion(newRegion);
    // In real app, this would also update user's currency preference in backend
  };
  ...
  const handleReferralSignup = () => {
    // Simulate a friend signing up through referral
    setReferrals(prev => {
  ...
  // Unlock Premium feature with points (for Basic users)
    ...
    <div className="min-h-screen bg-pupa-bg pt-16 pb-24 page-enter">
      <div className="px-5 pt-4">
        ...
        >
          ...
          {/* Demo button to simulate friend signing up */}
          <button
